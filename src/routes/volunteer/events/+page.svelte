...
<h1>Past Events</h1>
<p style="color:var(--text-light);margin-bottom:24px;">View past events of this season</p>
{#if pastEvents.length === 0}
	<div class="card"><p style="color:var(--text-light);">No past events in this season.</p></div>
{:else}
	<div style="display:flex;flex-direction:column;gap:12px;">
